...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdmExercisesHomeComponent", function() { return AdmExercisesHomeComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _exercises_form_exercises_form_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../exercises-form/exercises-form.component */ "./src/app/admin/exercises/exercises-form/exercises-form.component.ts");
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/dialog.js");
/* harmony import */ var src_app_services_exercises_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/exercises.service */ "./src/app/services/exercises.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _shared_exercise_item_exercise_item_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../shared/exercise-item/exercise-item.component */ "./src/app/shared/exercise-item/exercise-item.component.ts");
...
function AdmExercisesHomeComponent_app_exercise_item_4_Template(rf, ctx) { if (rf & 1) {
    const _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "app-exercise-item", 4);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AdmExercisesHomeComponent_app_exercise_item_4_Template_app_exercise_item_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const x_r1 = ctx.$implicit; const ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r2.changeroute(x_r1); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const x_r1 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("exercise", x_r1);
} }
class AdmExercisesHomeComponent {
    constructor(dialog, es, router, route) {
        this.dialog = dialog;
        this.es = es;
        this.router = router;
        this.route = route;
    ...
    ngOnInit() {
        this.es.getExercise().subscribe((data) => this.exercises = data, () => this.exercises = []);
    }
    changeroute(current) {
    ...
    loadDialog() {
        const dialogRef = this.dialog.open(_exercises_form_exercises_form_component__WEBPACK_IMPORTED_MODULE_1__["ExercisesFormComponent"], {
            width: '900px',
            height: '650px'
        });
...
AdmExercisesHomeComponent.ɵfac = function AdmExercisesHomeComponent_Factory(t) { return new (t || AdmExercisesHomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_exercises_service__WEBPACK_IMPORTED_MODULE_3__["ExercisesService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"])); };
AdmExercisesHomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AdmExercisesHomeComponent, selectors: [["app-adm-exercises-home"]], decls: 5, vars: 1, consts: [[1, "form-button", 3, "click"], ["src", "http://localhost:5000/files/images/exercise.png"], ["id", "exercises"], [3, "exercise", "click", 4, "ngFor", "ngForOf"], [3, "exercise", "click"]], template: function AdmExercisesHomeComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AdmExercisesHomeComponent_Template_div_click_0_listener() { return ctx.loadDialog(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AdmExercisesHomeComponent, [{
    ...
    }], function () { return [{ type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] }, { type: src_app_services_exercises_service__WEBPACK_IMPORTED_MODULE_3__["ExercisesService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] }]; }, null); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExercisesFormComponent", function() { return ExercisesFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var src_app_services_exercises_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/exercises.service */ "./src/app/services/exercises.service.ts");
...
function ExercisesFormComponent_h6_65_Template(rf, ctx) { if (rf & 1) {
...
function ExercisesFormComponent_input_66_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "input", 22);
} }
class ExercisesFormComponent {
    constructor(fb, es, dialogRef) {
        this.fb = fb;
        this.es = es;
    ...
    addExercise() {
        ...
        this.es.addExercise(formData).subscribe(() => { this.dialogRef.close(); }, () => { alert("Something Went Wrong"); });
    }
    ngOnInit() {
    }
}
ExercisesFormComponent.ɵfac = function ExercisesFormComponent_Factory(t) { return new (t || ExercisesFormComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_exercises_service__WEBPACK_IMPORTED_MODULE_2__["ExercisesService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialogRef"])); };
ExercisesFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ExercisesFormComponent, selectors: [["app-exercises-form"]], decls: 67, vars: 3, consts: [[3, "formGroup", "submit"], [1, "container"], [1, "left"], [1, "form-item"], [1, "label"], ["type", "text", "formControlName", "name"], ["formControlName", "description"], ["type", "number", "formControlName", "duration"], ["type", "number", "formControlName", "reps"], ["type", "number", "formControlName", "sets"], ["type", "number", "formControlName", "calrange1"], [1, "right"], ["type", "number", "formControlName", "calrange2"], ["type", "number", "formControlName", "calrange3"], ["formControlName", "difficulty"], ["type", "text", "formControlName", "bodypart"], ["type", "text", "formControlName", "equipment"], ["type", "file", "formControlName", "imagefile", 3, "change"], ["type", "file", "formControlName", "videofile", 3, "change"], [1, "submit-item"], [3, "color", "textAlign", 4, "ngIf"], ["type", "submit", "value", "add Exercise", 4, "ngIf"], ["type", "submit", "value", "add Exercise"]], template: function ExercisesFormComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "form", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function ExercisesFormComponent_Template_form_submit_0_listener() { return ctx.addExercise(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ExercisesFormComponent_Template_input_change_59_listener($event) { return ctx.uploadFile1($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ExercisesFormComponent_Template_input_change_63_listener($event) { return ctx.uploadFile2($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ExercisesFormComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: src_app_services_exercises_service__WEBPACK_IMPORTED_MODULE_2__["ExercisesService"] }, { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialogRef"] }]; }, null); })();
...
/* harmony import */ var _adm_exercises_home_adm_exercises_home_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./adm-exercises-home/adm-exercises-home.component */ "./src/app/admin/exercises/adm-exercises-home/adm-exercises-home.component.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _exercises_form_exercises_form_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./exercises-form/exercises-form.component */ "./src/app/admin/exercises/exercises-form/exercises-form.component.ts");
/* harmony import */ var src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shared/shared.module */ "./src/app/shared/shared.module.ts");
/* harmony import */ var _exercise_detail_exercise_detail_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./exercise-detail/exercise-detail.component */ "./src/app/admin/exercises/exercise-detail/exercise-detail.component.ts");
...
const route = [
    { path: "", component: _adm_exercises_home_adm_exercises_home_component__WEBPACK_IMPORTED_MODULE_2__["AdmExercisesHomeComponent"] },
    { path: "details", component: _exercise_detail_exercise_detail_component__WEBPACK_IMPORTED_MODULE_7__["ExerciseDetailComponent"] }
];
class ExercisesModule {
}
ExercisesModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: ExercisesModule });
ExercisesModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function ExercisesModule_Factory(t) { return new (t || ExercisesModule)(); }, imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ExercisesModule, { declarations: [_adm_exercises_home_adm_exercises_home_component__WEBPACK_IMPORTED_MODULE_2__["AdmExercisesHomeComponent"], _exercises_form_exercises_form_component__WEBPACK_IMPORTED_MODULE_5__["ExercisesFormComponent"], _exercise_detail_exercise_detail_component__WEBPACK_IMPORTED_MODULE_7__["ExerciseDetailComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ExercisesModule, [{
...
//# sourceMappingURL=admin-exercises-exercises-module-es2015.js.map