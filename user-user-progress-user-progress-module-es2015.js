...
/* harmony import */ var src_app_services_workout_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/workout.service */ "./src/app/services/workout.service.ts");
/* harmony import */ var src_app_services_progress_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/progress.service */ "./src/app/services/progress.service.ts");
...
function DailyActivityComponent_div_0_li_3_Template(rf, ctx) { if (rf & 1) {
    const _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "li", 7);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DailyActivityComponent_div_0_li_3_Template_li_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const y_r4 = ctx.index; const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r5.currentSelection(y_r4); });
...
function DailyActivityComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DailyActivityComponent_div_0_Template_input_ngModelChange_9_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r7.weight = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DailyActivityComponent_div_0_Template_button_click_15_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r9.updateProgress(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DailyActivityComponent_div_0_Template_button_click_23_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r10.stop(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](24, "Stop");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](25, "button", 12);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DailyActivityComponent_div_0_Template_button_click_25_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r11.timer(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DailyActivityComponent_div_0_Template_button_click_27_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r12.finish(); });
...
function DailyActivityComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " You Have not Subscribed to any Workout plans yet\n");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
class DailyActivityComponent {
    constructor(ps, ws, pss) {
        this.ps = ps;
        this.ws = ws;
        this.pss = pss;
        this.exercises = [];
    ...
    ngOnInit() {
        this.ps.getProfile().subscribe((profile) => {
            this.profile = profile;
            this.ws.getWorkoutByName(this.profile.subscription).subscribe((workout) => {
                this.workout = workout;
                this.ws.getWorkoutmap(this.workout.id).subscribe((data) => {
                    for (let x in data) {
                        this.exercises.push(data[x].exercise);
                        this.pss.getStatus(data[x].exercise.id).subscribe((data) => this.status[x] = { status: data.status, duration: data.duration });
                    }
                });
            });
        });
    ...
    finish() {
        ...
        if (this.currentDuration < 1)
            ...
            this.pss.setStatus(this.exercises[index].id, obj).subscribe((result) => {
    ...
    updateProgress() {
        ...
        if (this.weight == undefined || isNaN(this.weight) || this.weight < 100 || this.weight >= 300) {
            ...
            this.pss.setProgress(obj).subscribe(() => { alert("Updated"); }, () => { alert("Some issue"); });
        }
    }
}
DailyActivityComponent.ɵfac = function DailyActivityComponent_Factory(t) { return new (t || DailyActivityComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_profile_service__WEBPACK_IMPORTED_MODULE_1__["ProfileService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_workout_service__WEBPACK_IMPORTED_MODULE_2__["WorkoutService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_progress_service__WEBPACK_IMPORTED_MODULE_3__["ProgressService"])); };
DailyActivityComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DailyActivityComponent, selectors: [["app-daily-activity"]], decls: 2, vars: 2, consts: [["id", "container", 4, "ngIf"], ["id", "container"], ["id", "left"], [3, "click", 4, "ngFor", "ngForOf"], [1, "form-item"], ["for", "weight"], ["type", "text", 3, "ngModel", "ngModelChange"], [3, "click"], ["id", "right"], ["id", "timer-box"], ["id", "current-activity"], [1, "timer"], [3, "disabled", "click"], [3, "src"]], template: function DailyActivityComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DailyActivityComponent, [{
    ...
    }], function () { return [{ type: src_app_services_profile_service__WEBPACK_IMPORTED_MODULE_1__["ProfileService"] }, { type: src_app_services_workout_service__WEBPACK_IMPORTED_MODULE_2__["WorkoutService"] }, { type: src_app_services_progress_service__WEBPACK_IMPORTED_MODULE_3__["ProgressService"] }]; }, null); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UprogressHomeComponent", function() { return UprogressHomeComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");



class UprogressHomeComponent {
...
UprogressHomeComponent.ɵfac = function UprogressHomeComponent_Factory(t) { return new (t || UprogressHomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"])); };
UprogressHomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UprogressHomeComponent, selectors: [["app-uprogress-home"]], decls: 9, vars: 0, consts: [[1, "activity", 3, "click"], ["src", "http://localhost:5000/files/images/start.png"], ["src", "http://localhost:5000/files/images/table.png"], ["src", "http://localhost:5000/files/images/chart.png"]], template: function UprogressHomeComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "li", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UprogressHomeComponent_Template_li_click_0_listener() { return ctx.changeroute("activity"); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UprogressHomeComponent_Template_li_click_3_listener() { return ctx.changeroute("tables"); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UprogressHomeComponent_Template_li_click_6_listener() { return ctx.changeroute("graphs"); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UprogressHomeComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
LineChartComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LineChartComponent, selectors: [["app-line-chart"]], inputs: { multi: "multi", xAxisLabel: ["xaxis", "xAxisLabel"], yAxisLabel: ["yaxis", "yAxisLabel"] }, decls: 1, vars: 11, consts: [[3, "view", "scheme", "legend", "showXAxisLabel", "showYAxisLabel", "xAxis", "yAxis", "xAxisLabel", "yAxisLabel", "timeline", "results", "select", "activate", "deactivate"]], template: function LineChartComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "ngx-charts-line-chart", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("select", function LineChartComponent_Template_ngx_charts_line_chart_select_0_listener($event) { return ctx.onSelect($event); })("activate", function LineChartComponent_Template_ngx_charts_line_chart_activate_0_listener($event) { return ctx.onActivate($event); })("deactivate", function LineChartComponent_Template_ngx_charts_line_chart_deactivate_0_listener($event) { return ctx.onDeactivate($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserGraphsComponent", function() { return UserGraphsComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var src_app_services_progress_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/services/progress.service */ "./src/app/services/progress.service.ts");
/* harmony import */ var _line_chart_line_chart_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./line-chart/line-chart.component */ "./src/app/user/user-progress/user-graphs/line-chart/line-chart.component.ts");




class UserGraphsComponent {
    constructor(pf) {
        this.pf = pf;
    }
    ngOnInit() {
        this.pf.getProgress().subscribe((data) => {
            let result = [];
            let result2 = [];
            this.progress = data;
...
UserGraphsComponent.ɵfac = function UserGraphsComponent_Factory(t) { return new (t || UserGraphsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_progress_service__WEBPACK_IMPORTED_MODULE_1__["ProgressService"])); };
UserGraphsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UserGraphsComponent, selectors: [["app-user-graphs"]], decls: 9, vars: 2, consts: [[1, "container"], [1, "left"], ["xaxis", "Days", "yaxis", "Weight", 3, "multi"], ["xaxis", "Days", "yaxis", "Calories", 3, "multi"]], template: function UserGraphsComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserGraphsComponent, [{
    ...
    }], function () { return [{ type: src_app_services_progress_service__WEBPACK_IMPORTED_MODULE_1__["ProgressService"] }]; }, null); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserProgressModule", function() { return UserProgressModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _uprogress_home_uprogress_home_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./uprogress-home/uprogress-home.component */ "./src/app/user/user-progress/uprogress-home/uprogress-home.component.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _daily_activity_daily_activity_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./daily-activity/daily-activity.component */ "./src/app/user/user-progress/daily-activity/daily-activity.component.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _user_tables_user_tables_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./user-tables/user-tables.component */ "./src/app/user/user-progress/user-tables/user-tables.component.ts");
/* harmony import */ var _user_graphs_user_graphs_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./user-graphs/user-graphs.component */ "./src/app/user/user-progress/user-graphs/user-graphs.component.ts");
/* harmony import */ var _user_graphs_line_chart_line_chart_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./user-graphs/line-chart/line-chart.component */ "./src/app/user/user-progress/user-graphs/line-chart/line-chart.component.ts");
...
const route = [
    { path: "", component: _uprogress_home_uprogress_home_component__WEBPACK_IMPORTED_MODULE_2__["UprogressHomeComponent"] },
    { path: "activity", component: _daily_activity_daily_activity_component__WEBPACK_IMPORTED_MODULE_4__["DailyActivityComponent"] },
    { path: "tables", component: _user_tables_user_tables_component__WEBPACK_IMPORTED_MODULE_6__["UserTablesComponent"] },
    { path: "graphs", component: _user_graphs_user_graphs_component__WEBPACK_IMPORTED_MODULE_7__["UserGraphsComponent"] },
];
class UserProgressModule {
}
UserProgressModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: UserProgressModule });
UserProgressModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function UserProgressModule_Factory(t) { return new (t || UserProgressModule)(); }, imports: [[
            _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(route), _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _swimlane_ngx_charts__WEBPACK_IMPORTED_MODULE_9__["NgxChartsModule"]
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](UserProgressModule, { declarations: [_uprogress_home_uprogress_home_component__WEBPACK_IMPORTED_MODULE_2__["UprogressHomeComponent"], _daily_activity_daily_activity_component__WEBPACK_IMPORTED_MODULE_4__["DailyActivityComponent"], _user_tables_user_tables_component__WEBPACK_IMPORTED_MODULE_6__["UserTablesComponent"], _user_graphs_user_graphs_component__WEBPACK_IMPORTED_MODULE_7__["UserGraphsComponent"], _user_graphs_line_chart_line_chart_component__WEBPACK_IMPORTED_MODULE_8__["LineChartComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _swimlane_ngx_charts__WEBPACK_IMPORTED_MODULE_9__["NgxChartsModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserProgressModule, [{
...
function UserTablesComponent_tr_12_Template(rf, ctx) { if (rf & 1) {
...
function UserTablesComponent_tr_26_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "td");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
class UserTablesComponent {
    constructor(pf) {
        this.pf = pf;
        this.progress = [];
    }
    ngOnInit() {
        this.pf.getProgress().subscribe((data) => this.progress = data, () => this.progress = []);
    }
}
UserTablesComponent.ɵfac = function UserTablesComponent_Factory(t) { return new (t || UserTablesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_progress_service__WEBPACK_IMPORTED_MODULE_1__["ProgressService"])); };
UserTablesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UserTablesComponent, selectors: [["app-user-tables"]], decls: 27, vars: 2, consts: [[1, "table-content"], [1, "left-table"], [4, "ngFor", "ngForOf"], [1, "right-table"]], template: function UserTablesComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "h1");
...
//# sourceMappingURL=user-user-progress-user-progress-module-es2015.js.map