...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdminspageComponent", function() { return AdminspageComponent; });
...
/* harmony import */ var _usertable_usertable_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../usertable/usertable.component */ "./src/app/admin/users/admusers-home/usertable/usertable.component.ts");
...
class AdminspageComponent {
    ...
    ngOnInit() {
        this.us.getUsers('admin').subscribe((result) => this.users = result, () => this.users = []);
    }
    storeUser() {
        let obj = {
        ...
        this.username = "";
        this.log.register(obj).subscribe(() => { this.username = ""; alert("user added"); this.ngOnInit(); }, () => { this.username = ""; alert("try again"); });
    }
}
AdminspageComponent.ɵfac = function AdminspageComponent_Factory(t) { return new (t || AdminspageComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_login_service__WEBPACK_IMPORTED_MODULE_2__["LogService"])); };
AdminspageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AdminspageComponent, selectors: [["app-adminspage"]], decls: 9, vars: 3, consts: [[1, "form"], ["type", "text", 3, "ngModel", "ngModelChange"], ["mat-raised-button", "", 3, "disabled", "click"], ["color", "white", "aria-hidden", "false", "aria-label", "Example home icon"], [3, "users"]], template: function AdminspageComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h2");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Administrator users");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "input", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AdminspageComponent_Template_input_ngModelChange_3_listener($event) { return ctx.username = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "button", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AdminspageComponent_Template_button_click_4_listener() { return ctx.storeUser(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AdminspageComponent, [{
    ...
    }], function () { return [{ type: src_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"] }, { type: src_app_services_login_service__WEBPACK_IMPORTED_MODULE_2__["LogService"] }]; }, null); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdmusersHomeComponent", function() { return AdmusersHomeComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var src_app_services_user_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/user.service */ "./src/app/services/user.service.ts");
/* harmony import */ var _shared_dashboard_item_dashboard_item_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../shared/dashboard-item/dashboard-item.component */ "./src/app/shared/dashboard-item/dashboard-item.component.ts");





class AdmusersHomeComponent {
    constructor(router, route, us) {
        this.router = router;
        this.route = route;
        this.us = us;
    }
    ngOnInit() {
        this.us.getUserCount().subscribe((data) => this.usercount = data.count, () => this.usercount = 0);
        this.us.getAdminCount().subscribe((data) => this.admincount = data.count, () => this.usercount = 0);
    }
    changeroute(current) {
        this.router.navigate([current], { relativeTo: this.route.parent });
    }
}
AdmusersHomeComponent.ɵfac = function AdmusersHomeComponent_Factory(t) { return new (t || AdmusersHomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"])); };
AdmusersHomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AdmusersHomeComponent, selectors: [["app-admusers-home"]], decls: 2, vars: 2, consts: [["title", "Users", "imgurl", "http://localhost:5000/files/images/users.png", 3, "count", "click"], ["title", "Administrators", "imgurl", "http://localhost:5000/files/images/admins.png", 3, "count", "click"]], template: function AdmusersHomeComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "app-dashboard-item", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AdmusersHomeComponent_Template_app_dashboard_item_click_0_listener() { return ctx.changeroute("users"); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "app-dashboard-item", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AdmusersHomeComponent_Template_app_dashboard_item_click_1_listener() { return ctx.changeroute("admins"); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
    ...
    } }, directives: [_shared_dashboard_item_dashboard_item_component__WEBPACK_IMPORTED_MODULE_3__["DashboardItemComponent"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2FkbWluL3VzZXJzL2FkbXVzZXJzLWhvbWUvYWRtdXNlcnMtaG9tZS5jb21wb25lbnQuY3NzIn0= */"] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AdmusersHomeComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var src_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/services/user.service */ "./src/app/services/user.service.ts");
/* harmony import */ var _usertable_usertable_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../usertable/usertable.component */ "./src/app/admin/users/admusers-home/usertable/usertable.component.ts");
...
class UserspageComponent {
    ...
    ngOnInit() {
        this.us.getUsers('user').subscribe((result) => this.users = result, () => this.users = []);
    }
}
UserspageComponent.ɵfac = function UserspageComponent_Factory(t) { return new (t || UserspageComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"])); };
UserspageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UserspageComponent, selectors: [["app-userspage"]], decls: 3, vars: 1, consts: [[3, "users"]], template: function UserspageComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h2");
...
UsertableComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UsertableComponent, selectors: [["app-usertable"]], viewQuery: function UsertableComponent_Query(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵstaticViewQuery"](_angular_material_paginator__WEBPACK_IMPORTED_MODULE_1__["MatPaginator"], true);
    } if (rf & 2) {
        var _t;
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵqueryRefresh"](_t = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵloadQuery"]()) && (ctx.paginator = _t.first);
    } }, inputs: { users: "users" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]], decls: 14, vars: 5, consts: [[1, "user-tab"], ["mat-table", "", 3, "dataSource"], ["matColumnDef", "User Name"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "Email"], ["matColumnDef", "Created"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["showFirstLastButtons", "", 3, "pageSizeOptions"], ["mat-header-cell", ""], ["mat-cell", ""], ["mat-header-row", ""], ["mat-row", ""]], template: function UsertableComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _admusers_home_admusers_home_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./admusers-home/admusers-home.component */ "./src/app/admin/users/admusers-home/admusers-home.component.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/shared/shared.module */ "./src/app/shared/shared.module.ts");
/* harmony import */ var _admusers_home_userspage_userspage_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./admusers-home/userspage/userspage.component */ "./src/app/admin/users/admusers-home/userspage/userspage.component.ts");
/* harmony import */ var _admusers_home_adminspage_adminspage_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./admusers-home/adminspage/adminspage.component */ "./src/app/admin/users/admusers-home/adminspage/adminspage.component.ts");
/* harmony import */ var _admusers_home_usertable_usertable_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./admusers-home/usertable/usertable.component */ "./src/app/admin/users/admusers-home/usertable/usertable.component.ts");
/* harmony import */ var src_app_angmaterial_angmaterial_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/angmaterial/angmaterial.module */ "./src/app/angmaterial/angmaterial.module.ts");
...
const route = [
    { path: "", component: _admusers_home_admusers_home_component__WEBPACK_IMPORTED_MODULE_2__["AdmusersHomeComponent"] },
    { path: "users", component: _admusers_home_userspage_userspage_component__WEBPACK_IMPORTED_MODULE_5__["UserspageComponent"] },
    { path: "admins", component: _admusers_home_adminspage_adminspage_component__WEBPACK_IMPORTED_MODULE_6__["AdminspageComponent"] }
];
class UsersModule {
}
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](UsersModule, { declarations: [_admusers_home_admusers_home_component__WEBPACK_IMPORTED_MODULE_2__["AdmusersHomeComponent"], _admusers_home_userspage_userspage_component__WEBPACK_IMPORTED_MODULE_5__["UserspageComponent"], _admusers_home_adminspage_adminspage_component__WEBPACK_IMPORTED_MODULE_6__["AdminspageComponent"], _admusers_home_usertable_usertable_component__WEBPACK_IMPORTED_MODULE_7__["UsertableComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], src_app_angmaterial_angmaterial_module__WEBPACK_IMPORTED_MODULE_8__["AngmaterialModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_9__["FormsModule"]] }); })();
...
UserService.ɵfac = function UserService_Factory(t) { return new (t || UserService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_login_service__WEBPACK_IMPORTED_MODULE_2__["LogService"])); };
